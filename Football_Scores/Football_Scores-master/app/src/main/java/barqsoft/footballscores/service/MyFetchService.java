...
public class MyFetchService extends IntentService
{
    ...
    protected void onHandleIntent(Intent intent)
    {
        ...
        //getData("p2");
        /*
         * modified to show an entire week in appWidget
         */
        numRequests = 2;
        getData("n"+Integer.toString(Utilies.MAX_DAYS_LOOKAHEAD));
        getData("p"+Integer.toString(Utilies.MAX_DAYS_LOOKAHEAD));
        return;
    }
    ...
    private void getData (String timeFrame)
    {
        ...
        try {
            if (JSON_data != null) {
                ...
                if (matches.length() == 0 && (decRequestCount() <= 0)) {
                    //if there is no data, call the function on dummy data
                    //this is expected behavior during the off season.
                    Log.e(LOG_TAG, "Using simulated match data.");
                    processJSONdata(getString(R.string.dummy_data), getApplicationContext(), false);

                    return;
                }
                Log.e(LOG_TAG, "Using actual match data.");
